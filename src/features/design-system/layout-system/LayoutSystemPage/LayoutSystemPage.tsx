...
import { LAYOUT_SYSTEM_SHOWCASES } from './registry';
...
export function LayoutSystemPage() {
  ...
  return (
    <ShowcaseShell
      activeSystemId="layouts"
      groups={LAYOUT_SYSTEM_SHOWCASES}
      labels={{
        title: t('systems.layouts.title'),
        description: t('systems.layouts.subtitle'),
